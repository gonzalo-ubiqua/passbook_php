...
class AppConfigService {
    ...
    get clientScreenLogo() {
        return this.GenericInfo.logo_screen;
    }
    get clientLogoFooter() {
...
function View_HomeComponent_1(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](0, 0, null, null, 11, "section", [["class", "error-window"]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; if (("click" === en)) {
...
function View_HomeComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵpid"](0, _angular_common__WEBPACK_IMPORTED_MODULE_3__["DecimalPipe"], [_angular_core__WEBPACK_IMPORTED_MODULE_2__["LOCALE_ID"]]), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](1, 0, null, null, 6, "section", [["class", "ps-upload-image-section"]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; if (("click" === en)) {
        var pd_0 = (_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵnov"](_v, 4).click() !== false);
        ad = (pd_0 && ad);
    } return ad; }, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](2, 0, null, null, 4, "div", [["HTML5dropable", ""], ["class", "drop-area"]], [[4, "outline", null]], [[null, "drop"], [null, "dragover"], [null, "dragleave"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("dragover" === en)) {
...
class HomeComponent extends _others_file_reader_file_reader_abstract_component__WEBPACK_IMPORTED_MODULE_1__["FileReaderAbstractComponent"] {
    // ===========================================================================
    // ---------------------------------------------------------------------------
    constructor(InjectorS) {
        ...
        this.FileSendS = InjectorS.get(_others_file_reader_file_send_service__WEBPACK_IMPORTED_MODULE_2__["FileSendService"]);
    }
    // ---------------------------------------------------------------------------
    ngOnInit() {
        ...
        this.window_ind = 0;
        this.uploading_files = [];
        this.FileSendS.onProgress.subscribe((info) => {
            console.log("Filesend onProgress");
            console.info(info);
        });
        this.FileSendS.onComplete.subscribe((info) => {
        ...
        this.sb.e = this.FileSendS.onError.subscribe((error) => {
            this.uploading_files = [];
    ...
    // ---------------------------------------------------------------------------
    afterReaderFinish(file, readed_data) {
        this.window_ind = 0;
        try {
            // Validate CSV format
...
//   styleUrls: []
// })
class FileReaderAbstractComponent /* implements OnInit, OnDestroy */ {
    constructor() {
        this.file_list = [];
    ...
    onFileSelected($event) {
        ...
        for (file of $event.target.files) {
            const obj = _file_reader_service__WEBPACK_IMPORTED_MODULE_0__["FileReaderService"].getNew();
    ...
    // ---------------------------------------------------------------------------
    afterProgressAbs(obj, pct) {
        const current = this.file_list.find((e) => e.file == obj.current_File);
        if (current) {
    ...
    // ---------------------------------------------------------------------------
    afterFinishAbs(obj, readed_data) {
    ...
    setSubscriptions(obj) {
        ...
        obj.subs.pr = obj.onProgress.subscribe((pct) => this.afterProgressAbs(obj, pct));
        obj.subs.en = obj.onLoadEnd.subscribe((readed_data) => this.afterFinishAbs(obj, readed_data));
        obj.subs.er = obj.onError.subscribe((e) => this.afterErrorAbs(obj, e));
    }
    // ---------------------------------------------------------------------------
    unsetSubscriptions(obj) {
    ...
    uploadFinish(obj) {
        ...
        this.file_list = this.file_list.filter((e) => e.file !== obj.current_File);
    }
}
...
class FileReaderService {
    ...
    // ---------------------------------------------------------------------------
    static deleteInstances(instance_to_delete) {
        FileReaderService.instances = FileReaderService.instances.filter((e) => e !== instance_to_delete);
    }
    // ---------------------------------------------------------------------------
...
class FileSendService extends _services_remote_call_service__WEBPACK_IMPORTED_MODULE_1__["RemoteCallService"] {
    // ===========================================================================
    // ---------------------------------------------------------------------------
    constructor(InjectorS) {
        super(InjectorS);
        this.InjectorS = InjectorS;
        this.remoteCallParams = {
    ...
    // ===========================================================================
    // ---------------------------------------------------------------------------
    send(file_name, content_to_send) {
...
function View_PageHomeComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "button", [["mat-raised-button", ""], ["style", " position: absolute; right: 10px; top: 40px;"]], [[1, "disabled", 0], [2, "_mat-animation-noopable", null]], [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
...
class PageLoginComponent {
    // ===========================================================================
    constructor(LoginS, RemoteCallS) {
        this.LoginS = LoginS;
    ...
    // ---------------------------------------------------------------------------
    ngOnInit() {
        this.RemoteCallS.onError.subscribe((error) => {
            this.message = error;
        });
        this.RemoteCallS.onPost.subscribe((ret_data) => {
            if (ret_data.valid) {
...
class RemoteCallService {
    ...
    get psws_server_base() {
        // return this.sanitizer.bypassSecurityTrustUrl(this.AppConfig.remoteWS);
        // return this.sanitizer.bypassSecurityTrustHtml(this.AppConfig.serverURL);
        return this.AppConfig.serverURL;
    }
    // ---------------------------------------------------------------------------
    remotePost(post_data) {
        const self = this;
        const url = this.psws_server_base + '/' + post_data.php_name + '.php';
        self.HttpS.post(url, post_data, { 'headers': self.headers }).subscribe((response) => {
    ...
    remotePostRequest(end_point_name, post_data) {
        const self = this;
        // const fu_headers = new HttpHeaders()
        const url = this.psws_server_base + '/' + end_point_name + '.php';
        const postRequest = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', url, post_data, {
            // headers: fu_headers,
            reportProgress: true,
            // params: post_data,
            responseType: 'json'
        });
        this.HttpS.request(postRequest).subscribe((event) => {
            switch (event.type) {
        ...
        }, (error_HTML) => self.HTMLerrorHandler(error_HTML, this.errorSubject));
    }
    responseHandler(response, obs) {
    ...
    // ---------------------------------------------------------------------------
    HTMLerrorHandler(HTMLerror, obs) {
        let msg_error_html = '<h4>' + HTMLerror.message + '</h4>' +
